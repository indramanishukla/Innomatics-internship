...
df = pd.read_csv("C:/Users/Indramani Shukla/Downloads/Innomatics Internship/Streamlit/streamlit_assignment/open_pubs.csv", header=None, names=['fsa_id','name','address','postcode','easting','northing','latitude','longitude','local_authority'])
