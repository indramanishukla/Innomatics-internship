...
df = pd.read_csv(filename)
oe_load = load(open(basedir+'/pages/data/ordinal_encoder.pkl', 'rb'))
sc_load = load(open(basedir+'/pages/data/std_scaler.pkl', 'rb'))
dt_load = load(open(basedir+'/pages/data/decision_tree.pkl', 'rb'))
...
>>>>>>> 1deeeabbb72881e4d611f56b71e0418fc4cdc487
